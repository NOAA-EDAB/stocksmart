...
[![format-check.yaml](https://github.com/NOAA-EDAB/stocksmart/actions/workflows/format-check.yaml/badge.svg)](https://github.com/NOAA-EDAB/stocksmart/actions/workflows/format-check.yaml)
<!-- badges: end -->
...
*Date of most recent data pull: 2026-07-01 19:20:46*
