...
ATTENTION:  **NOAA Stock SMART system is undergoing some structural changes. Until this has been finalized and tested, the state of this repo has been frozen in time from September 25, 2024.**
...
The data are extracted and processed from NOAA's [Stock SMART](https://apps-st.fisheries.noaa.gov/stocksmart) web based data portal (https://apps-st.fisheries.noaa.gov/stocksmart).
